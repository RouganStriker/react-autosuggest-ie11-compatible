      ...
      var l =
        ...
        b = function(e) {
          var t = e.containerProps,
            n = e.children;
          return f.default.createElement('div', t, n);
        },
        w = (function(e) {
          function t(e) {
            ...
            c(t, [
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (n) {
                    var o = this.state,
                      i = o.highlightedSectionIndex,
                      r = o.highlightedSuggestionIndex;
                    if (
              ...
              },
              {
                ...
                value: function() {
                  var e,
                    ...
                    n = this.props,
                    o = n.suggestions,
                    u = n.renderInputComponent,
                    s = n.onSuggestionsFetchRequested,
                    a = n.renderSuggestion,
                    c = n.inputProps,
                    g = n.multiSection,
                    d = n.renderSectionTitle,
                    h = n.id,
                    p = n.getSectionSuggestions,
                    m = n.theme,
                    S = n.getSuggestionValue,
                    b = n.alwaysRenderSuggestions,
                    w = this.state,
                    x = w.isFocused,
                    _ = w.isCollapsed,
                    O = w.highlightedSectionIndex,
                    C = w.highlightedSuggestionIndex,
                    j = w.valueBeforeUpDown,
                    P = b ? I : this.props.shouldRenderSuggestions,
                    k = c.value,
                    R = c.onFocus,
                    T = c.onKeyDown,
                    ...
                    A = l(
                      ...
                      ((e = {
                        onFocus: function(e) {
                          if (
                            ...
                            var n = P(k);
                            t.setState({ isFocused: !0, isCollapsed: !n }),
                              R && R(e),
                              n && s({ value: k, reason: 'input-focused' });
                          }
                        },
                        onBlur: function(e) {
                          return t.justClickedOnSuggestionsContainer
                            ? void t.input.focus()
                            : ((t.blurEvent = e),
                              void (
                                t.justSelectedSuggestion ||
                      ...
                      i(e, H ? 'onInput' : 'onChange', function(e) {
                        var n = e.target.value,
                          o = P(n);
                        t.maybeCallOnChange(e, n, 'type'),
                          t.setState({
                            highlightedSectionIndex: null,
                            highlightedSuggestionIndex: null,
                            valueBeforeUpDown: null,
                          ...
                          o
                            ? s({ value: n, reason: 'input-changed' })
                            : t.onSuggestionsClearRequested();
                      }),
                      i(e, 'onKeyDown', function(e, n) {
                        switch (e.key) {
                          case 'ArrowDown':
                          case 'ArrowUp':
                            if (_)
                              ...
                              var i = n.newHighlightedSectionIndex,
                                r = n.newHighlightedItemIndex,
                                u = void 0;
                              (u =
                                null === r
                                  ? null === j
                                    ? k
                                    : j
                                  : t.getSuggestionValueByIndex(i, r)),
                                t.updateHighlightedSuggestion(i, r, k),
                                t.maybeCallOnChange(
                                  e,
                                  u,
                                  'ArrowDown' === e.key ? 'down' : 'up'
                                );
                            }
                            e.preventDefault(),
                          ...
                          case 'Enter':
                            ...
                            var a = t.getHighlightedSuggestion();
                            if ((E && !b && t.closeSuggestions(), null !== a)) {
                              var l = S(a);
                              t.maybeCallOnChange(e, l, 'enter'),
                          ...
                          case 'Escape':
                            ...
                            if (null === j) {
                              if (!c) {
                                var g = '';
                                t.maybeCallOnChange(e, g, 'escape'),
                                  P(g)
                                    ? s({ value: g, reason: 'escape-pressed' })
                                    : t.onSuggestionsClearRequested();
                              }
                            } else t.maybeCallOnChange(e, j, 'escape');
                            c
                              ? (t.onSuggestionsClearRequested(),
                                t.closeSuggestions())
                  ...
                  return f.default.createElement(v.default, {
                    ...
                    highlightedItemIndex: C,
                    inputProps: A,
                    itemProps: this.itemProps,
                    theme: (0, y.mapToAutowhateverTheme)(m),
                    id: h,
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return g.default.createElement('div', h, m, v);
                }
              }
            ]),
            t
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    g = t.theme,
                    f = t.keyPrefix,
                    d = null === u ? f : f + 'section-' + u + '-',
                    p = 'function' == typeof o;
                  return c.default.createElement(
                    'ul',
                    s({ role: 'listbox' }, g(d + 'items-list', 'itemsList')),
                    n.map(function(t, n) {
                      var f = 0 === n,
                        m = n === a,
                        v = d + 'item-' + n,
                      ...
                      return (
                        m && (I.ref = e.storeHighlightedItemReference),
