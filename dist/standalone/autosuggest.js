            ...
            _createClass(Autosuggest, [
              ...
              },
              {
                ...
                value: function componentDidUpdate(prevProps, prevState) {
                  var onSuggestionHighlighted = this.props
                  ...
                  if (
                    highlightedSectionIndex !==
                      prevState.highlightedSectionIndex ||
                    highlightedSuggestionIndex !==
                ...
                value: function render() {
                  ...
                  var _props2 = this.props,
                    ...
                    onSuggestionsFetchRequested =
                      _props2.onSuggestionsFetchRequested,
                  ...
                  var _state3 = this.state,
                    ...
                    highlightedSuggestionIndex =
                      _state3.highlightedSuggestionIndex,
                  ...
                  var onChange = inputProps.onChange,
                    otherInputProps = _objectWithoutProperties(inputProps, [
                      'onChange'
                    ]);

                  var autowhateverInputProps = _extends(
                    {},
                    otherInputProps,
                    ((_extends2 = {
                    ...
                    _defineProperty(_extends2, 'onKeyDown', function onKeyDown(
                      event,
                      data
                    ) {
                      switch (event.key) {
          ...
          var _initialiseProps = function _initialiseProps() {
            ...
            this.highlightFirstSuggestion = function() {
              _this3.updateHighlightedSuggestion(
                _this3.props.multiSection ? 0 : null,
                0
              );
            };
            ...
            this.onSuggestionsClearRequested = function() {
              var onSuggestionsClearRequested =
                _this3.props.onSuggestionsClearRequested;
            ...
            this.onSuggestionClick = function(event) {
              var _props4 = _this3.props,
                ...
                focusInputOnSuggestionClick =
                  _props4.focusInputOnSuggestionClick;
              ...
              var clickedSuggestion = _this3.getSuggestion(
                sectionIndex,
                suggestionIndex
              );
            ...
            this.renderSuggestionsContainer = function(_ref5) {
              ...
              var renderSuggestionsContainer =
                _this3.props.renderSuggestionsContainer;
